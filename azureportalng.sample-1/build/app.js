...
(function (Sample1) {
    var Sample1Shell = /** @class */ (function (_super) {
        ...
        function Sample1Shell(portalService) {
            ...
            _this.portalService.panorama.avatarMenu.userAccount = new AzurePortalNg.UserAccount('useraccount@mail.com', 'first', 'last');
            var tile = _this.portalService.panorama.startboard.tiles.addTile(new AzurePortalNg.Tile('Navigation 1', '/app/nav1/nav1.html', portalService));
            tile.subTitle = 'TypeScript based';
            var tile = _this.portalService.panorama.startboard.tiles.addTile(new AzurePortalNg.Tile('Blade 1-1', '/app/blade11/blade11.html', portalService));
            tile.subTitle = 'TypeScript based';
            var tile = _this.portalService.panorama.startboard.tiles.addTile(new AzurePortalNg.Tile('Blade 2', '/app/blade2/blade2.html', portalService));
            tile.subTitle = 'TypeScript based';
            var tile = _this.portalService.panorama.startboard.tiles.addTile(new AzurePortalNg.Tile('Blade 2-1', '/app/blade21/blade21.html', portalService));
            tile.subTitle = 'TypeScript based';
            var tile = _this.portalService.panorama.startboard.tiles.addTile(new AzurePortalNg.Tile('List 1', '/app/list1/list1.html', portalService));
            tile.subTitle = 'TypeScript based';
            var tile = _this.portalService.panorama.startboard.tiles.addTile(new AzurePortalNg.Tile('Detail 1', '/app/detail1/detail1.html', portalService));
            tile.subTitle = 'TypeScript based';
        ...
        Sample1Shell.prototype.$onInit = function () { };
        // #endregion
        //#region Methods
...
(function (Sample1) {
    ...
    var Blade11 = /** @class */ (function (_super) {
        ...
        function Blade11(portalService) {
            var _this = _super.call(this, portalService, '/app/blade11/blade11.html', 'Blade 1-1', 'TypeScript based', 315) || this;
        ...
        //#endregion
        // #region Angular Methods
        Blade11.prototype.$onInit = function () { };
        // #endregion
...
(function (Sample1) {
    ...
    var Blade2 = /** @class */ (function (_super) {
        ...
        function Blade2(portalService) {
            var _this = _super.call(this, portalService, '/app/blade2/blade2.html', 'Blade 2', 'TypeScript based', 315) || this;
            _this.isCommandNew = true;
        ...
        //#endregion
        // #region Angular Methods
        Blade2.prototype.$onInit = function () { };
        // #endregion
        //#region Methods - Overrides for Blade
...
(function (Sample1) {
    ...
    var Blade21 = /** @class */ (function (_super) {
        ...
        function Blade21(portalService) {
            var _this = _super.call(this, portalService, '/app/blade21/blade21.html', 'Blade 2-1', 'TypeScript based', 315) || this;
            _this.isCommandNew = true;
            _this.commandNewText = 'Blade 2';
        ...
        //#endregion
        // #region Angular Methods
        Blade21.prototype.$onInit = function () { };
        // #endregion
        //#region Methods - Overrides for Blade
...
(function (Sample1) {
    ...
    var Detail1 = /** @class */ (function (_super) {
        ...
        function Detail1(portalService) {
            var _this = _super.call(this, portalService, '/app/detail1/detail1.html', 'Detail-1', 'TypeScript based', 415) || this;
            _this.activate();
            return _this;
        }
        //#endregion
        // #region Angular Methods
        Detail1.prototype.$onInit = function () { };
        // #endregion
        //#region Methods
...
(function (Sample1) {
    ...
    var List1 = /** @class */ (function (_super) {
        ...
        function List1(portalService) {
            var _this = _super.call(this, portalService, '/app/list1/list1.html', 'List-1', 'TypeScript based', 315) || this;
            _this.activate();
            return _this;
        }
        //#endregion
        // #region Angular Methods
        List1.prototype.$onInit = function () { };
        // #endregion
        //#region Methods
...
(function (Sample1) {
    var Nav1 = /** @class */ (function (_super) {
        ...
        function Nav1(portalService) {
            ...
            AzurePortalNg.Debug.write('[sample1-debug] \'Nav1\' constructor called.', [_this]);
            _this.navItems = [
                new AzurePortalNg.BladeNavItem('Navigation 1 (BladeNav)', '/app/nav1/nav1.html'),
                new AzurePortalNg.BladeNavItem('Blade 1-1 (BladeList)', '/app/blade11/blade11.html', null, null, true, _this.callback1, _this),
        ...
        //#endregion
        // #region Angular Methods
        Nav1.prototype.$onInit = function () { };
        // #endregion
        //#region Methods
