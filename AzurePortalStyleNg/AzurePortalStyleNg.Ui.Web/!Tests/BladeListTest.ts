...
if (result31 !== false) { console.log('> Test 31: Should be false'); } else { console.log('> Test 31 sucessfull'); }

// TEST 32
var result32 = sut.onFilter('Harry', 'h y r');
if (result32 !== true) { console.log('> Test 32: Should be true'); } else { console.log('> Test 32 sucessfull'); }
