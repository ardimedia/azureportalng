module Sample1 {
    ...
    class SampleShell extends AzurePortalNg.PortalShell {
        ...
        constructor(portalService: AzurePortalNg.PortalService) {
            ...
            tile.subTitle = 'Javascript based';
            ...
            var tile = this.portalService.panorama.startboard.tiles.addTile(new AzurePortalNg.Tile('Blade 1', '/Sample1/blade1/blade1.html', portalService));
            tile.subTitle = 'JavaScript based';
